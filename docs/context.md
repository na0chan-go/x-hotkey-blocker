...
- ポスト内アクション欄に `🚫` ボタンを挿入し、ボタンクリックでもブロック実行可能
- 任意トリガー設定を実装
  - 修飾キー: `meta / ctrl / alt / shift / none`
  - マウスボタン: `left / middle / right`
...
- 最新Release: `https://github.com/na0chan-go/x-hotkey-blocker/releases/latest`
- Releaseにzipを添付して、一般ユーザーにはREADMEの導入手順を案内
...
- 右クリックをトリガーにする場合、コンテキストメニューとの競合に注意
